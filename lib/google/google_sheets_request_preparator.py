...
class GoogleSheetsRequestPreparator:
    ...
    def prepare_sheet_formatting_request(cls, sheet_id, formatting_matrix):
        ...
        format_requests.append(cls.generate_request_for_row_sizes(sheet_id, 40, 43, 35))
        format_requests.append(cls.generate_request_for_row_sizes(sheet_id, 44, 44, 70))
        format_requests.append(cls.generate_request_for_row_sizes(sheet_id, 45, 60, 30))
